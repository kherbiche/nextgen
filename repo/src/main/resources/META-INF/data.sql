...
INSERT INTO ADDRESS(id, CITY, COUNTRY, ZIP_CODE, NUM_ADDRESS, STREET_NAME, TYPE_ADDRESS) VALUES(2, 'tls', 'fr', 31000, 111, 'massensen road', 'ROAD');
...
INSERT INTO ADDRESS(id, CITY, COUNTRY, ZIP_CODE, NUM_ADDRESS, STREET_NAME, TYPE_ADDRESS)  VALUES(3, 'nan', 'fr', 92000, 17, 'takfarinas road', 'ROAD');
...
INSERT INTO ADDRESS(id, CITY, COUNTRY, ZIP_CODE, NUM_ADDRESS, STREET_NAME, TYPE_ADDRESS) VALUES(4, 'lni', 'dza', 15555, 2, 'tinhinane avenue', 'AVENUE');

INSERT INTO PROMOTER(FIRST_NAME, LAST_NAME, BIRTH_DATE, ANEM_CARD, BIRTH_CERT_NUM, BIRTH_CITY, BIRTH_COUNTRY, BIRTH_ZIP_CODE, DEGREE, EDUC_LEVEL, EMAIL, EXPERIENCE, FAMILYSITUATION, FATHER, FAX, GENDER, MOTHER, PHONE, FK_ADDRESS) VALUES('first4', 'last4', '19/10/1990', 15991990, '199019104', 'lni', 'dz', 15540, 'bio', 'OTH', 'first4@yahoo.com', 'Without', 'Single', 'ha', 099999, 'F', 'ka', 066666, 4);



INSERT INTO ADDRESS(id, CITY, COUNTRY, ZIP_CODE, NUM_ADDRESS, STREET_NAME, TYPE_ADDRESS) VALUES(5, 'el passo', 'usa', 19670, 10, 'micipsa street', 'STREET');

INSERT INTO PROMOTER(BIRTH_DATE, FIRST_NAME, LAST_NAME, ANEM_CARD, BIRTH_CERT_NUM, BIRTH_CITY, BIRTH_COUNTRY, BIRTH_ZIP_CODE, DEGREE, EDUC_LEVEL, EMAIL, EXPERIENCE, FAMILYSITUATION, FATHER, FAX, GENDER, MOTHER, PHONE, FK_ADDRESS) VALUES ('12/01/1990', 'lys', 'kh', 151699, '12019099', 'lni', 'Dz', 15550, 'Miage','OTH', 'sith', 'Without', 'Single', 'sl', 9999, 'M', 'al', 6666, 5);
